...
namespace HospitalManagementSystemCSharp {
    ...
    public partial class hospitalDataSet1 : global::System.Data.DataSet {
        ...
        public partial class patientDataTable : global::System.Data.TypedTableBase<patientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public patientRow AddpatientRow(int Id, string name, string gen, string age, string date, string cont, string addr, string disease, string price, string Priority) {
        ...
        public partial class patientRow : global::System.Data.DataRow {
            ...
            public string Priority {
                get {
                    try {
                        return ((string)(this[this.tablepatient.PriorityColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Priority\' in table \'patient\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablepatient.PriorityColumn] = value;
                }
            }
            ...
            public bool IsPriorityNull() {
                return this.IsNull(this.tablepatient.PriorityColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPriorityNull() {
                this[this.tablepatient.PriorityColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace HospitalManagementSystemCSharp.hospitalDataSet1TableAdapters {
    ...
    public partial class patientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [patient] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_cont = 1 AND [cont] IS NULL) OR ([cont] = @Original_cont)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_disease = 1 AND [disease] IS NULL) OR ([disease] = @Original_disease)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [patient] ([name], [gen], [age], [date], [cont], [addr], [disease], [price]) VALUES (@name, @gen, @age, @date, @cont, @addr, @disease, @price);
SELECT Id, name, gen, age, date, cont, addr, disease, price FROM patient WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [patient] SET [name] = @name, [gen] = @gen, [age] = @age, [date] = @date, [cont] = @cont, [addr] = @addr, [disease] = @disease, [price] = @price WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)) AND ((@IsNull_cont = 1 AND [cont] IS NULL) OR ([cont] = @Original_cont)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_disease = 1 AND [disease] IS NULL) OR ([disease] = @Original_disease)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT Id, name, gen, age, date, cont, addr, disease, price FROM patient WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, gen, age, date, cont, addr, disease, price,Priority FROM patient" +
                "";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_gen, string Original_age, string Original_date, string Original_cont, string Original_addr, string Original_disease, string Original_price) {
        ...
        public virtual int Insert(string name, string gen, string age, string date, string cont, string addr, string disease, string price) {
            if ((name == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_disease, 
                    string Original_price) {
            return this.Update(name, gen, age, date, cont, addr, disease, price, Original_Id, Original_name, Original_gen, Original_age, Original_date, Original_cont, Original_addr, Original_disease, Original_price, Original_Id);
        }
    }
