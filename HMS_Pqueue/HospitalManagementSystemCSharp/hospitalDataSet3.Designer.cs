...
namespace HospitalManagementSystemCSharp {
    ...
    public partial class hospitalDataSet3 : global::System.Data.DataSet {
        ...
        public partial class checkoutDataTable : global::System.Data.TypedTableBase<checkoutRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public checkoutRow AddcheckoutRow(string name, string gen, string age, string contact, string addr, string disease, string date_in, string date_out, string build, string med_price, string total) {
...
namespace HospitalManagementSystemCSharp.hospitalDataSet3TableAdapters {
    ...
    public partial class checkoutTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [checkout] ([name], [gen], [age], [contact], [addr], [disease], [date_in], [date_out], [build], [med_price], [total]) VALUES (@name, @gen, @age, @contact, @addr, @disease, @date_in, @date_out, @build, @med_price, @total);
SELECT Id, name, gen, age, contact, addr, disease, date_in, date_out, build, med_price, total FROM checkout WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [checkout] SET [name] = @name, [gen] = @gen, [age] = @age, [contact] = @contact, [addr] = @addr, [disease] = @disease, [date_in] = @date_in, [date_out] = @date_out, [build] = @build, [med_price] = @med_price, [total] = @total WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_contact = 1 AND [contact] IS NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_disease = 1 AND [disease] IS NULL) OR ([disease] = @Original_disease)) AND ((@IsNull_date_in = 1 AND [date_in] IS NULL) OR ([date_in] = @Original_date_in)) AND ((@IsNull_date_out = 1 AND [date_out] IS NULL) OR ([date_out] = @Original_date_out)) AND ((@IsNull_build = 1 AND [build] IS NULL) OR ([build] = @Original_build)) AND ((@IsNull_med_price = 1 AND [med_price] IS NULL) OR ([med_price] = @Original_med_price)) AND ((@IsNull_total = 1 AND [total] IS NULL) OR ([total] = @Original_total)));
SELECT Id, name, gen, age, contact, addr, disease, date_in, date_out, build, med_price, total FROM checkout WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, gen, age, contact, addr, disease, date_in, date_out, build, med_" +
                "price, total FROM checkout";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_gen, string Original_age, string Original_contact, string Original_addr, string Original_disease, string Original_date_in, string Original_date_out, string Original_build, string Original_med_price, string Original_total) {
            ...
            if ((Original_med_price == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[20].Value = ((string)(Original_med_price));
            }
            if ((Original_total == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[22].Value = ((string)(Original_total));
            }
        ...
        public virtual int Insert(string name, string gen, string age, string contact, string addr, string disease, string date_in, string date_out, string build, string med_price, string total) {
            if ((name == null)) {
            ...
            if ((med_price == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(med_price));
            }
            if ((total == null)) {
        ...
        public virtual int Update(
            ...
            if ((med_price == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(med_price));
            }
            if ((total == null)) {
            ...
            if ((Original_date_in == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((string)(Original_date_in));
            }
            if ((Original_date_out == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((string)(Original_date_out));
            }
            if ((Original_build == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((string)(Original_build));
            }
            if ((Original_med_price == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[31].Value = ((string)(Original_med_price));
            }
            if ((Original_total == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_med_price, 
                    string Original_total) {
            return this.Update(name, gen, age, contact, addr, disease, date_in, date_out, build, med_price, total, Original_Id, Original_name, Original_gen, Original_age, Original_contact, Original_addr, Original_disease, Original_date_in, Original_date_out, Original_build, Original_med_price, Original_total, Original_Id);
        }
    }
